...
export default function Login() {
    ...
    return (
        <div className="relative flex h-dvh w-full overflow-hidden">
            ...
            <div className="surface-ink relative hidden h-full w-1/2 overflow-hidden p-10 text-mist lg:flex lg:flex-col lg:px-16 lg:py-12">
                ...
                <h1 className="relative max-w-lg text-4xl font-semibold leading-tight tracking-tight text-white">
                    Panel admin untuk tunnel L2TP berlangganan.
                </h1>
                <p className="relative mt-4 max-w-lg text-sm leading-relaxed text-mist/70">
                    Alurnya sederhana: hubungkan CHR, isi pelanggan, ambil script, lalu push. Pantau siapa yang online dan kapan masa aktif habis.
                </p>
                <div className="relative mt-10 max-w-lg space-y-4">
                    {highlights.map((item) => (
            ...
            <div className="relative flex h-full min-w-0 flex-1 flex-col justify-center bg-white px-6 py-10 sm:px-12">
